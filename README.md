[![Release](https://img.shields.io/badge/release-1.0.3--rc-blue.svg)](https://github.com/SupLuo/HaloPermission/releases)
...
```
    dependencies {
        ...
        compile('halo.android:permission:1.0.3-rc@aar'){
            //传递依赖
            transitive = true
        }
    }
